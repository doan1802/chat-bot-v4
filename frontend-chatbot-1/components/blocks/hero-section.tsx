          ...
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                ...
                src="bg6.png"
                alt="background"
                className="absolute inset-x-0 top-0 -z-20 hidden dark:block"
                width="3276"
                height="4095"
              />
            </AnimatedGroup>
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">Introducing AI Chatbot with Real-time Voice</span>
                ...
                >
                  ...
                  <div key={2} className="rounded-[14px] border p-0.5">
                    <Button asChild size="lg" variant="ghost" className="rounded-xl px-5 text-base hover:bg-foreground/10">
                      <Link href="#link">
                        <span className="text-nowrap">Try Voice Demo</span>
                      </Link>
                    </Button>
                  </div>
                </AnimatedGroup>
            ...
            >
              <div className="relative mt-8 overflow-hidden px-2 sm:mt-12 md:mt-20">
                ...
                <img
                    className="bg-background w-full h-auto relative hidden rounded-2xl dark:block object-cover"
                    src="cap.jpeg"
                    alt="app screen"
                    width="2700"
                    height="1440"
                  />
                  <img
                    className="z-2 border-border/25 w-full h-auto relative rounded-2xl border dark:hidden object-cover"
                    src="cap.jpeg"
                    alt="app screen"
                    width="2700"
                    height="1440"
...
const menuItems = [
  ...
  { name: "Voice AI", href: "#link" },
  { name: "MCP Technology", href: "#link" },
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
              ...
              <ul className="flex gap-8 text-sm">
                {menuItems.map((item, index) => (
                  <li key={index}>
                    <Link
                      href={item.href}
                      className="text-white block duration-150 relative"
                    >
            ...
            >
              ...
              <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                <Button asChild variant="ghost" size="sm" className={cn("hover:bg-foreground/10", isScrolled && "lg:hidden")}>
                  <Link href="/signin">
                    <span>Login</span>
                  </Link>
                </Button>
...
const Logo = ({ className }: { className?: string }) => {
  return (
    <div className="flex items-center gap-2">
      {/* <svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("h-5 w-auto", className)}>
      ...
      <span className="font-bold text-xl">Serna</span>
    </div>
  )
}
