        ...
        <div className="mx-auto grid gap-4 lg:grid-cols-2">
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                ...
                description="Advanced AI voice processing with natural language understanding."
              />
            </CardHeader>
          ...
          <FeatureCard>
            <CardHeader className="pb-3">
              <CardHeading
                icon={Calendar}
                title="MCP Technology Integration"
                description="Cutting-edge MCP technology for enhanced AI conversation capabilities."
              />
            </CardHeader>
          ...
          <FeatureCard className="p-6 lg:col-span-2">
            <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">
              Seamless AI chatbot experience with real-time voice capabilities powered by MCP.
            </p>
